...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-93fu4uw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-93fu4uw.containers.anotherwebservice.com/
...
```
git clone git@github.com:watrushka/container-93fu4uw.git
cd container-93fu4uw
```
...
```
docker attach container-93fu4uw
```
